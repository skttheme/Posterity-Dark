...
<header id="header" class="<?php echo esc_attr( $header_classes ); ?>"<?php posterity_schema_args( 'header' ); ?>>
	<div class="head">
		...
		<?php if ( $menu_on ): ?>
           <div id="header-tools"><button id="mobile-menu-opener" class="a13icon-menu tool" title="<?php esc_attr_e( 'Main menu', 'posterity-dark' ); ?>"><span class="screen-reader-text"><?php esc_html_e( 'Main menu', 'posterity-dark' ); ?></span></button></div><?php endif; ?>
